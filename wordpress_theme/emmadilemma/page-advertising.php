<?php
/**
 * Template Name: Advertising Work Page
 *
 * This is the template that displays the posts with the category of advertising.
 *
 * @package CustomTheme
...
<section id="Container" class="container">
    <h2 class="section-headline section-headline-blog-page">Advertising</h2>
    ...
    <div class="row gallery-container">
        <section>
            <?php $my_query = new WP_Query( 'category_name=advertising>' ); ?>
