<?php
/**
 * Template Name: Web Work Page
 *
 * This is the template that displays the posts with the category of web.
 *
 * @package CustomTheme
...
<section id="Container" class="container">
   <h2 class="section-headline section-headline-blog-page">Web</h2>
   ...
   <?php get_template_part('template-parts/projectcat', 'single'); ?>
    <div class="row gallery-container">
      <section>
          <?php $my_query = new WP_Query( 'category_name=web>' ); ?>
